...
import { CustomWidgetIframeProps, CustomWidgetIframe } from "./custom-widget-iframe";
...
const factory: BlockFactory = (BaseBlockClass, _widgetApi) => {
  /**
   *  <custom-widget-iframe message="world!"></custom-widget-iframe>
   */
  return class CustomWidgetIframeBlock extends BaseBlockClass implements BaseBlock {
    public constructor() {
      super();
    }

    private get props(): CustomWidgetIframeProps {
      const attrs = this.parseAttributes<CustomWidgetIframeProps>();
      return {
        ...attrs,
    ...
    public renderBlock(container: HTMLElement): void {
      ReactDOM.render(<CustomWidgetIframe {...this.props} />, container);
    }
